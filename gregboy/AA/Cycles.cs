...
namespace Gregboy {
    public static class Cycles {
        ...
        public static readonly int RETURNTRUE = 20;
        public static readonly int RETURNFALSE = 8;
        public static readonly int JUMPTRUE = 16;
        public static readonly int JUMPFALSE = 12;
        public static readonly int CALLTRUE = 24;
        public static readonly int CALLFALSE = 12;
        public static readonly int JUMPRELATIVETRUE = 12;
        public static readonly int JUMPRELATIVEFALSE = 8;
